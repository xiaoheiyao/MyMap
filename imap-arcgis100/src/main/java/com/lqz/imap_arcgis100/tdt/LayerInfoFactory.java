    ...
    public static TianDiTuLayerInfo getLayerInfo(int layerType) {
        ...
        switch (layerType) {
            ...
            case TianDiTuLayerTypes.TIANDITU_VECTOR_2000:
                layerInfo.setUrl(TianDiTuConstants.URL_VECTOR_2000);
                break;
            case TianDiTuLayerTypes.TIANDITU_VECTOR_MERCATOR:
                layerInfo.setUrl(TianDiTuConstants.URL_VECTOR_MERCATOR);
                break;
            case TianDiTuLayerTypes.TIANDITU_VECTOR_ANNOTATION_CHINESE_2000:
                layerInfo.setUrl(TianDiTuConstants.URL_VECTOR_ANNOTATION_CHINESE_2000);
                break;
            case TianDiTuLayerTypes.TIANDITU_VECTOR_ANNOTATION_CHINESE_MERCATOR:
                layerInfo.setUrl(TianDiTuConstants.URL_VECTOR_ANNOTATION_CHINESE_MERCATOR);
                break;
            case TianDiTuLayerTypes.TIANDITU_IMAGE_2000:
                layerInfo.setUrl(TianDiTuConstants.URL_IMAGE_2000);
                break;
            case TianDiTuLayerTypes.TIANDITU_IMAGE_MERCATOR:
                layerInfo.setUrl(TianDiTuConstants.URL_IMAGE_MERCATOR);
                break;
            case TianDiTuLayerTypes.TIANDITU_IMAGE_ANNOTATION_CHINESE_2000:
                layerInfo.setUrl(TianDiTuConstants.URL_IMAGE_ANNOTATION_CHINESE_2000);
                break;
            case TianDiTuLayerTypes.TIANDITU_IMAGE_ANNOTATION_CHINESE_MERCATOR:
                layerInfo.setUrl(TianDiTuConstants.URL_IMAGE_ANNOTATION_CHINESE_MERCATOR);
                break;
            case TianDiTuLayerTypes.TIANDITU_TERRAIN_2000:
                layerInfo.setUrl(TianDiTuConstants.URL_TERRAIN_2000);
                break;
            case TianDiTuLayerTypes.TIANDITU_TERRAIN_MERCATOR:
                layerInfo.setUrl(TianDiTuConstants.URL_TERRAIN_MERCATOR);
                break;
            case TianDiTuLayerTypes.TIANDITU_TERRAIN_ANNOTATION_CHINESE_2000:
                layerInfo.setUrl(TianDiTuConstants.URL_TERRAIN_ANNOTATION_CHINESE_2000);
                break;
            case TianDiTuLayerTypes.TIANDITU_TERRAIN_ANNOTATION_CHINESE_MERCATOR:
                layerInfo.setUrl(TianDiTuConstants.URL_TERRAIN_ANNOTATION_CHINESE_MERCATOR);
                break;
